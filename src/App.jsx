  ...
  return (
    <div className="bg-white text-black">
      ...
      <p className="text-left py-3 font-sans text-xl">
        ...
        her. <br />
        Your parents will marry Ankita off to a stranger guy in a year whose
        past & future you will have no clue about and whose only plus point will
        be he is of same cast, and even Ankita will get ready to sacrifice her
        happiness for your family's sake.
        <br />
        <br />
        Me and Ankita understand each other so well. We have spent so much time
        togather, made the future plans togather, So in love that I can not
        imagine my future without her. And day by day my fear of losing her is
        increasing. I am feeling anxious, depressed & mentally stressed because
        I can not imagine my life without her. All I've told you is just a glass
        of water from the ocean and there is so much more about our story.
        <br />
        But the point is I wanna marry Ankita, take care of her & worship her
        for lifetime. <br />
        ...
        <ul className="list-disc ml-5 hover:list-roman">
          ...
          <li>
            I have little interest in content creation so I create some content
            for Instagram on <a href="https://www.instagram.com/lifeofaadesh">@lifeofaadesh</a> 
          </li>
          <li>
            My family is supportive and successful. My father works
            in L&T (now schneider elextrical) in quality department. My mother
            is a homemaker.
          </li>
          <li>
            My younger sister is also a Computer Engineer (2023) from PICT Pune (Top IT college in Pune) 
            and she has joined a company right after college with 18 LPA CTC.
          </li>
          <li>
